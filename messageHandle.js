...
module.exports =
    {
        messageHandler: function (msg, Bot) {
            ...
            let omegaluls = [];
            omegaluls[0] = Bot.emojis.cache.find(emote => emote.name === 'OMEGALUL').toString(); //OMEGALUL
            omegaluls[1] = Bot.emojis.cache.find(emote => emote.name === 'smolOME').toString(); //smolOME
